			...
			>
				...
				{showCloseButton ? (
					<DialogPrimitive.Close
						className="absolute top-4 right-4 rounded-xs opacity-70 outline-none transition-opacity hover:opacity-100 focus:ring-[3px] focus:ring-ring/50 focus:outline-none disabled:pointer-events-none"
